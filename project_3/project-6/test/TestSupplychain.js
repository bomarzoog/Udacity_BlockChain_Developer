...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async() => {
        ...
        assert.equal(resultBufferTwo[5], itemState, 'Error: Invalid item state');
        assert.equal(eventEmitted, true, 'Error: Invalid event emitted');
        assert.equal(resultBufferTwo[7], retailerID, 'Error: Invalid retailID');
        assert.equal(resultBufferOne[2], retailerID, 'Error: Invalid retailID');
    ...
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async() => {
        ...
        assert.equal(resultBufferTwo[5], itemState, 'Error: Invalid item state');
        assert.equal(eventEmitted, true, 'Error: Invalid event emitted');
        assert.equal(resultBufferTwo[8], consumerID, 'Error: Invalid retailID');
        assert.equal(resultBufferOne[2], consumerID, 'Error: Invalid retailID');
    })    
